...
var RateButton = React.createClass({displayName: "RateButton",
	openRatePage: function() {
		chrome.tabs.query({
			active: true,
			currentWindow: true
		}, function (tabs) {
  ...
  render: function() {
    return (
      React.createElement("a", {onClick: this.openRatePage, id: "rate", className: "rate btn-time waves-effect waves-light btn"}, 
      	React.createElement("i", {className: "mdi-action-favorite-outline left"}), 
        	React.createElement("span", null, "Rate Me"), 
        React.createElement("i", {className: "mdi-action-favorite-outline right"})
      )
    );
  }
...
var StopButton = React.createClass({displayName: "StopButton",
  ...
  render: function() {
  	//console.log(this.props.tabTime);
    var stopBtn = this.props.tabTime !== 0 ? (React.createElement("a", {onClick: this.props.handleDelete, 
      className: "waves-effect waves-light btn red lighten-3"}, "Stop")) : (React.createElement("a", {
      className: "waves-effect waves-light btn red"}, React.createElement("i", {className: "mdi-action-done left"}), 
      "Stop"));
...
var TimeButton = React.createClass({displayName: "TimeButton",
	...
	handleTimeUpdate: function(e) {
		this.props.handleTabTimeUpdate(this.props.btnTime);
	},
  render: function() {

  	var btn = this.props.tabTime === this.props.btnTime ? (React.createElement("a", {className: "btn-time waves-effect waves-light btn teal"}, 
        React.createElement("i", {className: "mdi-action-done left"}), this.props.btnDesc)) : (React.createElement("a", {onClick: this.handleTimeUpdate, className: "btn-time waves-effect waves-light btn teal lighten-4"}, 
        this.props.btnDesc));
...
var React = require('react');
var TimeButton = require('./TimeButton.js');
var RateButton = require('./RateButton.js');
var StopButton = require('./StopButton.js');
...
var Main = React.createClass({displayName: "Main",
  ...
  handleTabTimeUpdate: function(newTime) {
		var options = {};		
		options.interval = newTime;
		options.refresh = true;

		localStorage[this.state.tab.url] = JSON.stringify(options);
  ...
  componentDidMount: function() {
      ...
      var options = self.getOptions(tabs[0]);
      if (options !== null) {
        self.setState({time: parseInt(options.interval), tab:tabs[0]});
      }
    });
  },
  ...
  render: function() {
    var timeNodes = this.intervalTable.map(function(timeRow, index) {
      return (
        React.createElement(TimeButton, {handleTabTimeUpdate: this.handleTabTimeUpdate, tabTime: this.state.time, 
          btnTime: timeRow.time, btnDesc: timeRow.desc, key: index})
      );
    }, this);
    return (
      React.createElement("div", {className: "time-btns"}, 
        React.createElement("h4", null, "Refresh"), 
        React.createElement("a", {onClick: this.openOptionPage, className: "btn-floating waves-effect waves-light right"}, 
          React.createElement("i", {className: "mdi-action-list"})), 

        React.createElement(StopButton, {tabTime: this.state.time, handleDelete: this.handleDelete}), 
      	timeNodes, 
        React.createElement(RateButton, null)
      )
    );
  }
...
},{"./RateButton.js":179,"./StopButton.js":180,"./TimeButton.js":181,"react":178}],183:[function(require,module,exports){
(function () {
...
},{"./components/main.js":182,"react-tap-event-plugin":5,"react/addons":6}]},{},[183])